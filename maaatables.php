...
function maaa_statsfintdstring($maaa_funcamt, $maaa_funcdiv) {
	...
	$maaa_statsfintd = '<td width="15%" style="text-align:right">$' . $amtDLs . '</td><td width="15%" style="text-align:left">.' . $amtDRs . '</td>';
	
	return $maaa_statsfintd;
}
				...
				<td width="75%" style="border-left: double #1188ee">
					<table id="statsfin" style="padding-left: 35px">
						...
						<tr>
							...
							<?php echo maaa_statsfintdstring( $maaa_cattotal,1 ); // td 10%R 20%L code for total ?>
							<?php echo maaa_statsfintdstring( $maaa_cattotal,$maaa_daysum ); // td 10%R 20%L code for per diem ?>
						</tr>
						<?php
						foreach ($maaa_catfins as $maaa_catfin) {
							...
							if ($maaa_catfin_c != "") { ?>
								<tr>
									<td width="40%"><?php echo $maaa_catfin_c; ?></td>
									<?php echo maaa_statsfintdstring( $maaa_catfin_f,1 ); // td 10%R 20%L code for total ?>
									<?php echo maaa_statsfintdstring( $maaa_catfin_f,$maaa_daysum ); // td 10%R 20%L code for per diem ?>
								</tr>
							<?php } //end if
						} //end foreach
						?>
